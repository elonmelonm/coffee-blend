        ...
        <div class="wrap d-md-flex align-items-xl-end">
            ...
            <div class="book p-4">
                ...
                <form action="{{ route('booking.tables') }}}}" method="POST" class="appointment-form">
                    ...
                    <div class="d-md-flex">
                        <div class="form-group">
                            <textarea name="" id="" name="message" cols="30" rows="2" class="form-control"
                        ...
                        @endif
                        <div class="form-group ml-md-4">
                            <input type="submit" name="submit" value="Book" class="btn btn-primary py-3 px-4">
                        </div>
                    </div>
                </form>
            </div>
                ...
                <div class="col-md align-self-sm-end ftco-animate">
                    <div class="testimony">
                        ...
                        <div class="author d-flex mt-4">
                            {{-- <div class="image mr-3 align-self-center"><img src="images/person_1.jpg" alt="">
                            </div> --}}
